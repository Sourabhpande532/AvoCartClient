...
export const Wishlist = () => {
    const { wishlist, removeFromWishlist } = useAppFeatures();
    ...
    return (
        <div>
            ...
            <div className='row'>
                { Array.isArray( wishlist ) && wishlist.length > 0 && wishlist.map( ( w ) => (
                    <div key={ w._id } className='col-md-4 mb-3'>
                        <div className='card'>
                            <img
                                src={ w?.product?.images?.[0] || "https://picsum.photos/id/2/209/300" }
                            ...
                            <div className='card-body'>
                                ...
                                <div className='d-flex gap-2'>
                                    ...
                                    <button className='btn btn-outline-danger btn-sm' onClick={ () => removeFromWishlist( w._id ) }>
                                        Remove
                                    </button>
                                </div>
                            </div>
